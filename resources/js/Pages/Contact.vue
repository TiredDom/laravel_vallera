...
const faqs = ref([
    ...
    },
    {
        ...
        a: 'Currently, we only ship within the United States and Canada. We are working on expanding our shipping options to more countries in the near future. Please subscribe to our newsletter for updates.',
        open: false
    },
    {
                ...
                <div class="bg-white rounded-2xl shadow-lg p-8" data-aos="fade-left" data-aos-delay="200">
                     ...
                     <form @submit.prevent="submit" class="space-y-5">
                         <div>
                            ...
                            <input v-model="form.name" type="text" id="name" class="mt-1 block w-full bg-zinc-50 border-zinc-300 rounded-lg shadow-sm py-3 px-4 focus:ring-primary-500 focus:border-primary-500">
                         </div>
                         <div>
                            <label for="email" class="font-medium text-zinc-700">Email</label>
                            <input v-model="form.email" type="email" id="email" class="mt-1 block w-full bg-zinc-50 border-zinc-300 rounded-lg shadow-sm py-3 px-4 focus:ring-primary-500 focus:border-primary-500">
                         </div>
                         <div>
                            <label for="subject" class="font-medium text-zinc-700">Subject</label>
                            <input v-model="form.subject" type="text" id="subject" class="mt-1 block w-full bg-zinc-50 border-zinc-300 rounded-lg shadow-sm py-3 px-4 focus:ring-primary-500 focus:border-primary-500">
                         </div>
                         <div>
                            <label for="message" class="font-medium text-zinc-700">Message</label>
                            <textarea v-model="form.message" id="message" rows="4" class="mt-1 block w-full bg-zinc-50 border-zinc-300 rounded-lg shadow-sm py-3 px-4 focus:ring-primary-500 focus:border-primary-500"></textarea>
                         </div>
