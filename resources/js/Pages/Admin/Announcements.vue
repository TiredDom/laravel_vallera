                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-slate-600">Create and manage system announcements</p>
                        </div>
                    </div>
                    <div class="flex items-center gap-3">
                        <button
                            @click="manualRefresh"
                            class="px-4 py-2 bg-white text-slate-700 border border-slate-300 rounded-lg font-semibold hover:bg-slate-50 transition-all shadow hover:shadow-md flex items-center gap-2"
                        ...
                        <button
                            ...
                            class="px-4 py-2 bg-gradient-to-r from-cyan-600 to-blue-600 text-white rounded-lg font-semibold hover:from-cyan-700 hover:to-blue-700 transition-all shadow-lg hover:shadow-xl flex items-center gap-2"
                        >
                            <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
