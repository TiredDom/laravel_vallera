<template>
    ...
    <div class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="grid grid-cols-2 lg:grid-cols-5 gap-3 sm:gap-4 mb-6" data-aos="fade-up">
                <div class="bg-white rounded-xl shadow-lg border-2 border-emerald-200 p-4 sm:p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-2xl sm:text-3xl font-bold text-emerald-600">{{ products.length }}</p>
                ...
                <div class="bg-white rounded-xl shadow-lg border-2 border-blue-200 p-4 sm:p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-2xl sm:text-3xl font-bold text-blue-600">{{ featuredCount }}/3</p>
                ...
                <div class="bg-white rounded-xl shadow-lg border-2 border-amber-200 p-4 sm:p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-2xl sm:text-3xl font-bold text-amber-600">{{ totalStock }}</p>
                ...
                <div class="bg-white rounded-xl shadow-lg border-2 border-orange-200 p-4 sm:p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-2xl sm:text-3xl font-bold text-orange-600">{{ lowStockCount }}</p>
                ...
                <div class="bg-white rounded-xl shadow-lg border-2 border-red-200 p-4 sm:p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-2xl sm:text-3xl font-bold text-red-600">{{ outOfStockCount }}</p>
